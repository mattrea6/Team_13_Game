...
hot_fire_hard_bars = [
	...
	"No wonder you're sore now, Lordy you're bored now. I’m pushing 30 you’re breaking 40’s door down.",
	"Had a spark when you stared but now you're just garbage, fell from 'Top 10' to 'not mentioned at all'.",
...
blend_easy_bars = [
	...
	"Man, you're so fat. You're the reason why double doors were invented.",
	"If I wanted to kill myself I’d climb your ego and jump to your IQ.",
	"You'll never be the man your mother is.",
	"I'm sorry, was I meant to be offended? The only thing offending is your face",
